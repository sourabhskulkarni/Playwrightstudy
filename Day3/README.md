...
## Real-time Example: Complete MakeMyTrip Framework (BDD Style)
See `examples/features/` folder for the complete framework structure written in Cucumber Gherkin.
